...
use btwearable_entities::activities;
use btwearable_types::activities::{ActivityPeriod, ActivityType, SearchActivityPeriods};
use sea_orm::{
...
mod tests {
    ...
    async fn create_and_search_activities() {
        ...
        let sleep = btwearable_algos::SleepCycle {
            id: sleep_date,
