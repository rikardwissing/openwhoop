...
import {
  applyElasticHeartZoomScaleLimit,
  ...
  PannableHeartChart,
  resolveNearestHeartPinchZoomStep,
...
describe('chart gesture ownership', () => {
  it('derives stable viewport geometry for the pannable heart chart', () => {
    ...
    expect(getHeartWindowPointCountForZoomScale(13, 2)).toBe(7);
    expect(applyElasticHeartZoomScaleLimit(15, 0.25, 12)).toBeCloseTo(12.54);
    expect(
      resolveNearestHeartPinchZoomStep(154, [
        { value: '1h', windowPointCount: 13 },
        { value: '3h', windowPointCount: 37 },
        { value: '6h', windowPointCount: 73 },
        { value: '12h', windowPointCount: 145 },
        { value: '24h', windowPointCount: 289 },
        { value: '48h', windowPointCount: 577 },
      ]),
    ).toEqual({ value: '12h', windowPointCount: 145 });
  });
