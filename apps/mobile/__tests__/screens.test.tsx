...
describe('screen rendering', () => {
  ...
  it('keeps today heart zoom presets on the cached 5 minute heart window', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.queryByTestId('today-heart-chart-zoom-6h')).toBeNull();
    ...
    act(() => {
      screen.UNSAFE_getByType(PannableHeartChart).props.onPinchZoomStepChange?.('6h');
    });
    ...
    act(() => {
      screen.UNSAFE_getByType(PannableHeartChart).props.onPinchZoomStepChange?.('1h');
    });
    ...
    act(() => {
      screen.UNSAFE_getByType(PannableHeartChart).props.onPinchZoomStepChange?.('24h');
    });
    ...
    act(() => {
      screen.UNSAFE_getByType(PannableHeartChart).props.onPinchZoomStepChange?.('48h');
    });
